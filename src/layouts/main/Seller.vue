...
<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <the-customizer
            ...
            />
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/gift.png')" title="Seller" parent=".layout--main" />
...
import sidebarItems from "@/layouts/components/vx-sidebar/sellerSideBarItems.js";
