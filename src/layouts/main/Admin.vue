...
<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/gift.png')" title="Admin" parent=".layout--main" />
...
import sidebarItems from "@/layouts/components/vx-sidebar/adminSideBarItems.js";
